...
<head>
    ...
    <meta name="keywords" content="asha, ashar alo shop, asharalo, asha alo, ASHAR shop, premium products, high-quality, online shopping"/>
...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1996841609387194"
   ...
   <meta name="google-adsense-account" content="ca-pub-1996841609387194">
     <link rel="ads.txt" type="ads" href="https://www.asharaloshop.xyz/public/ads.txt">
    ...
    <meta http-equiv="refresh" content="600; url=https://www.asharaloshop.xyz"/>

    <link rel="canonical" href="https://www.asharaloshop.xyz"/>
    <meta name="target-audience" content="men, women, eco-conscious consumers" />
    <meta name="location" content="Bangladesh" />
    
    <meta property="og:title" content="Ashar Alo Shop - Premium Quality Products for You" />
    <meta property="og:description" content="Explore our collection of Asha, Asharalo, and more. Shop with confidence at Ashar Alo Shop." />
    <meta property="og:image" content="https://www.asharaloshop.xyz/public/img/hero/banner.jpg" />
    <meta property="og:url" content="https://www.asharaloshop.xyz"/>
    <meta property="og:type" content="website"/>
    <meta property="fb:app_id" content="1095177278380295"/>
    <meta property="og:image:alt" content="Ashar Alo Shop"/>
        ...
        <script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "item": {
      "@type": "Product",
      "name": "Fantech GP12 Revolver Gaming Controller",
      "url": "https://www.asharaloshop.xyz/"
    }
  },{
    "@type": "ListItem",
    "position": 2,
    "item": {
      "@type": "Product",
      "name": "Category",
      "url": "https://www.asharaloshop.xyz/products"
    }
  }]
}
</script>
    ...
    <script type="application/ld+json">
        {
          ...
          "name": "Ashar Alo Shop",
          "url": "https://www.asharaloshop.xyz/",
          "logo": "https://www.asharaloshop.xyz/public/img/logo.PNG",
          "description": "Your one-stop destination for premium quality products.",
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "Doripara",
    ...
    <meta name="geo.placename" content="Jamalpur, Bangladesh"/>
...
<!-- Header Section Begin --><header class="header">
            ...
            <div class="col-lg-9">
                ...
                <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
                    <div class="hero__text">
                        ...
                        <h1>GET 100% <br />Authentic <br />Product</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="product__discount__item">
                    <a href="{{route('shop-details',['product'=>$prod->id])}}">
                        <div class="product__discount__item__pic set-bg"
                             data-setbg="{{asset('storage/'.$prod->image)}}">
                            @if(isset($prod->discount))
                                <div class="product__discount__percent">{{$prod->discount}}%</div>
                            @endif
                        </div>
                    </a>
                    <div class="product__discount__item__text">
                        <span>{{$prod->sub_category}}</span>
                        <h5><a href="{{route('shop-details',['product'=>$prod->id])}}">{{$prod->product_name}}</a></h5>
                        <div class="product__item__price">TK {{$prod->price}}
                            @if(isset($prod->discount))
                            <span>TK {{$prod->previous_price}}</span>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="latest-product__slider owl-carousel">
                        <div class="latest-prdouct__slider__item">
                            @foreach($lateset as $late)
                                <a href="{{route('shop-details',['product'=>$late->id])}}" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset('storage/'.$late->image)}}" alt="{{$late->product_name}}">
                                    </div>
                        ...
                        <div class="latest-prdouct__slider__item">
                            @foreach($most as $mosted)
                                @if($mosted->total_sold > 15)
                                    <a href="{{route('shop-details',['product'=>$mosted->id])}}" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="{{asset('storage/'. $mosted->image)}}" alt="{{$mosted->product_name}}">
                                        </div>
                                        <div class="latest-product__item__text">
            ...
            <div class="col-lg-12">
                <div class="footer__copyright">
                    <div class="footer__copyright__text"><p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by Ashar Alo Shop | Developed by <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.trodev.com" target="_blank">Trodev</a></p></div>
